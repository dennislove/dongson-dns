...
import nhansu from '../../images/nhansu.jpg'
    ...
    <div className='bg-cover bg-[#000022]'>
       <div className=' max-w-[1300px] m-auto relative pt-10'>
        <div className='relative text-center mb-10'>
            ...
            <div className=' grid grid-cols-3 gap-4 mt-5 bg-white rounded'>
              <img src={nhansu} alt="" className='w-full bg-cover col-span-2' />
              <div className=' col-span-1 flex flex-col gap-4 justify-center text-center text-black px-5 bg-gray-200 rounded-xl mr-3 my-3'>
